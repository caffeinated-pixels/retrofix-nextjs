...
export const mediaCollection: MediaCollection = [
  ...
  },
  {
    ...
    cast: 'Kurt Russell, Lee Van Cleef, Donald Pleasence',
    slug: 'escape-new-york',
    id: '5',
  },
  {
  ...
  },
  {
    ...
    description: 'Ghost in the Shell: Stand Alone Complex',
    category: 'series',
    genre: 'sci-fi',
    subgenres: 'action',
    maturity: '15',
  ...
  },
  {
    ...
    year: '1981',
    length: '1 season',
    cast: 'Simon Jones, David Dixon, Peter Jones',
  ...
  },
  {
    ...
    cast: "Tadanobu Asano, Nao Ōmori, Shin'ya Tsukamoto",
  ...
  },
  {
    ...
    category: 'series',
    genre: 'drama',
    subgenres: 'spy, thriller',
    maturity: '14',
    year: '1979',
    length: '1 season',
    cast: 'Alec Guinness, Alexander Knox, Ian Richardson',
    slug: 'tinker-tailor',
    id: '35',
  },
  {
    ...
    category: 'series',
    genre: 'drama',
    subgenres: 'horror, mystery',
    maturity: 'MA',
    year: '2000',
    length: '1 season',
    cast: 'Ren ÔsugiNaoki HosakaTomoko Nakajima',
    slug: 'mpd-psycho',
    id: '36',
  },
  {
  ...
  },
  {
    ...
    cast: 'Dan Aykroyd, Harold Ramis, Bill Murray',
    slug: 'ghostbusters',
    id: '43',
  },
  {
  ...
  },
  {
    ...
    length: '1h 34m',
    director: 'Stanley Kubrick',
    cast: 'George C. Scott, Peter Sellers, Slim Pickens',
    slug: 'dr-strangelove',
    id: '46',
  },
  {
  ...
  },
  {
    title: 'Red Dwarf',
    description:
      'As the last human man standing on the mining ship Red Dwarf, Dave Lister, the human-evolved Cat, and the hologram Rimmer are left to aimlessly wander the future.',
    category: 'series',
    genre: 'comedy',
    subgenres: 'sci-fi',
    maturity: '15',
  ...
  },
  {
    title: 'Blackadder',
    description:
      'Blackadder follows the misfortunes of the ever-scheming Edmund Blackadder and his multiple incarnations from 1485 to 1917. ',
    category: 'series',
    genre: 'comedy',
    maturity: 'PG',
    year: '1982',
    length: '4 seasons',
    cast: 'Rowan Atkinson, Tim McInnerny, Tony Robinson',
    slug: 'blackadder',
    id: '49',
  },
  {
  ...
  },
  {
    ...
    description:
      'The series is set in a Hospital in Romford, which is situated over the gates of Hell.',
    category: 'series',
    genre: 'comedy',
    maturity: '15',
    year: '2004',
    length: '1 season',
    cast: 'Richard Ayoade, Matt Berry, Matthew Holness',
    slug: 'darkplace',
    id: '51',
  },
  {
    ...
    category: 'series',
    genre: 'comedy',
    subgenres: 'animation, music',
    maturity: 'MA',
    year: '2006',
    length: '4 seasons',
    cast: 'Brendon Small, Tommy Blacha, Mark Hamill',
    slug: 'metalocalypse',
    id: '52',
  },
  {
  ...
  {
    title: 'Jam',
    description: 'A surreal, ambient mix of bleak comedy sketches.',
    category: 'series',
    genre: 'comedy',
    maturity: 'MA',
    year: '2000',
    length: '1 season',
    cast: 'Christopher Morris, Amelia Bullmore, David Cann',
    slug: 'jam',
    id: '55',
  },
  {
    title: 'Brass Eye',
    description:
      "Chris Morris' controversal spoof of current affairs television, and the role of celebrity in the UK.",
    category: 'series',
    genre: 'comedy',
    maturity: 'MA',
    year: '1997',
    length: '1 season',
    cast: 'Christopher Morris, Mark Heap, Kevin Eldon',
    slug: 'brass-eye',
    id: '56',
  },
  {
    ...
    year: '1999',
    length: '2 seasons',
    cast: 'Simon Pegg, Nick Frost, Jessica Hynes',
    slug: 'spaced',
    id: '57',
  },
  {
    title: "Jodorwky's Dune",
    description:
    ...
    cast: 'Alejandro Jodorowsky, Chris Foss, H.R. Giger',
    slug: 'jodorwkys-dune',
    id: '58',
  },
  {
    ...
    cast: 'Frank Zappa, Lonnie Lardner, Patrice Zappa',
    slug: 'zappa',
    id: '59',
  },
  {
    ...
    cast: 'Daryl Hannah, Rutger Hauer, Harrison Ford',
    slug: 'dangerous-days',
    id: '60',
  },
  {
    title: 'Searching for the Wrong-Eyed Jesus',
    description:
      'Alternative-country musician Jim White guides documentarian Andrew Douglas through the music and culture of the American South. ',
    category: 'films',
    genre: 'documentaries',
    subgenres: 'music',
    maturity: 'PG',
    ...
    cast: 'Jim White, Harry Crews, Johnny Dowd',
    slug: 'wrong-eyed-jesus',
    id: '61',
  },
  {
    ...
    slug: 'hearts-of-darkness',
    id: '62',
  },
  {
    title: 'From Bedrooms to Billions',
    description:
      'A feature length documentary movie telling the remarkable, true story of the British Video Games Industry from 1979 to the present day.',
    category: 'films',
    genre: 'documentaries',
    maturity: 'PG',
    year: '2014',
    ...
    cast: 'Shahid Ahmad, Nigel Alderton, Nick Alexander ',
    slug: 'bedrooms-to-billions',
    id: '63',
  },
  {
  ...
  },
  {
    ...
    cast: 'Steve Wiebe, Billy Mitchell, Mark Alpiger',
    slug: 'king-of-kong',
    id: '65',
  },
  {
    ...
    year: '1969',
    length: '1 season',
    cast: 'Kenneth Clark, Ian Richardson, Ronald Lacey',
    slug: 'civilisation',
    id: '66',
  },
  {
    title: 'Screenwipe',
    description: "Charlie Brooker's caustic satirical take on the world of TV.",
    category: 'series',
    genre: 'documentaries',
    subgenres: 'comedy',
    maturity: 'MA',
    year: '2006',
    length: '5 seasons',
    cast: 'Charlie Brooker, Al Campbell, David Firth',
    slug: 'screenwipe',
    id: '67',
  },
  {
    ...
    category: 'series',
    genre: 'documentaries',
    subgenres: 'history, war',
    maturity: '15',
    year: '1973',
    length: '1 season',
    cast: 'Laurence Olivier, Albert Speer, Anthony Eden',
    slug: 'world-at-war',
    id: '68',
  },
  {
    ...
    description:
      'Ken Burns and Lynn Novick’s ten-part documentary tells the epic story of one of the most consequential, divisive, and controversial events in American history.',
    category: 'series',
    genre: 'documentaries',
    subgenres: 'history, war',
    maturity: 'MA',
    year: '2017',
    length: '1 season',
    cast: 'Peter Coyote, Huy Duc, James Willbanks',
    slug: 'vietnam-war',
    id: '69',
  },
  {
    title: 'Abroad in Britain',
    description:
      'Jonathan Meades explores British place and culture in a series of films devoted to the proposition that the exotic begins at home.',
    category: 'series',
    genre: 'documentaries',
    maturity: 'PG',
    year: '1990',
    ...
    slug: 'abroad-in-britain',
    id: '70',
  },
  {
    title: 'Even Further Abroad',
    description:
      'Once again casting an eye on British place and culture, Jonathan Meades peels off the drab brown overcoat of preconception to reveal the lime green posing pouch of reality beneath.',
    category: 'series',
    genre: 'documentaries',
    maturity: 'PG',
    year: '1997',
    length: '1 season',
    cast: 'Jonathan Meades',
    slug: 'even-further-abroad',
    id: '71',
  },
  {
    title: 'Victoria Died in 1901 and is Still Alive Today',
    description:
      "Jonathan Meades explores the ever-enduring and often pernicious architectural and cultural legacy of Queen Victoria's reign.",
    category: 'series',
    genre: 'documentaries',
    maturity: 'PG',
    year: '2001',
    length: '1 episode',
    cast: 'Jonathan Meades, Christopher Biggins, Skandar Keynes',
    slug: 'victoria-died',
    id: '72',
  },
  {
    ...
    description:
      'Historian Simon Schama explores eight of the great artists and the relationship between their work and the historical context of its creation.',
    category: 'series',
    genre: 'documentaries',
    maturity: '12',
    year: '2006',
    length: '1 season',
    cast: 'Simon Schama, Grégoire Bonnet, Allan Corduner',
    slug: 'power-of-art',
    id: '73',
  },
  {
  ...
  },
  {
    ...
    length: '1h 28m',
    director: 'John Woo',
    cast: 'Chow Yun-Fat, Tony Chiu-Wai Leung, Teresa Mo',
    slug: 'hard-boiled',
    id: '76',
  },
  {
    ...
    length: '1h 35m',
    director: 'John Woo',
    cast: 'Lung Ti, Leslie Cheung, Chow Yun-Fat',
    slug: 'better-tommorrow',
    id: '77',
  },
  {
  ...
  },
  {
    title: 'Miami Vice',
    description:
      'Miami Vice follows two undercover detectives and their extended team through the mean streets of Miami, Florida.',
    category: 'series',
    genre: 'action',
    subgenres: 'crime',
    maturity: '15',
  ...
  },
  {
    ...
    description:
      'A physical game show where 100 contestants attempt to progress through a series of devious and elaborate obstacles to face off with Count Takeshi and his minions.',
    category: 'series',
    genre: 'action',
    subgenres: 'comedy',
    maturity: 'PG',
    year: '1986',
    length: '2 seasons',
    cast: 'Takeshi Kitano, Hayato Tani, Michiru Jo',
  ...
  },
  {
    ...
    year: '1989',
    length: '9 seasons',
    cast: 'Jôji Yanami, Kyle Hebert, Masako Nozawa',
    slug: 'dragon-ball-z',
    id: '88',
  },
]
