...
type NavbarProps = {
  /**
   * apply custom padding to navbar
   */
  $padding?: string
}
...
type NavPrimaryBtnProps = {
  $isActive?: boolean
}

export const NavPrimaryBtn = styled(BurgerButton)<NavPrimaryBtnProps>`
  margin: 0;
  color: #e5e5e5;
...
type SearchInputDesktopProps = {
  $isSearchOpen?: boolean
}

export const SearchInputDesktop = styled(SearchInput)<SearchInputDesktopProps>`
